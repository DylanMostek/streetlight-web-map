import{i0 as $e,a0 as x,aI as U,a6 as Fe,jH as et,dY as Bt,eN as Ht,hV as Wt,fm as L,hJ as Ut,oW as kt,jt as Yt,vZ as tt,a8 as c,a9 as H,aa as at,v_ as Zt,v$ as qt,jR as Q,H as ot,jK as Oe,hT as De,hH as Xt,lz as Jt,w0 as k,_ as he,gr as rt,ju as ne,cj as re,dv as Kt,dx as Qt,dJ as ea,bw as ta,j0 as aa,c$ as oa,as as z,eT as ra,i6 as ia,aK as na,ay as sa,e3 as we,e4 as la,eb as Ge,av as ca,hK as da,a2 as ua}from"./index-CCjLDPmS.js";import{ab as P,i as me,d as pe,aX as I,a as it,aY as fe,aZ as nt,a_ as st,a$ as ha,b0 as W,b1 as ma,b2 as pa,ad as fa,f as va,b3 as J,r as N,a2 as ae,D as A,E as j,b4 as D,G as K,b as y,I as G,al as ga,H as xa,b5 as ba,b6 as lt,q as se,aj as ct,o as dt,aU as ut,g as wa,j as Ne,k as ve,s as ht,b7 as ya,aH as Ma,u as Ta,v as Be,ah as _a,aa as _,aF as Ie,ag as Sa,b8 as Ca,c as ee,b9 as za,W as oe,ba as $a,M as Fa,bb as mt,a9 as le,F as pt,L as ft,K as vt,bc as gt,J as xt,Q as Oa,U as Na,N as Ia,O as Va,P as La,R as Pa,V as Ea,X as Ra,T as Aa,Y as ja,x as m,A as Da,bd as ye,be as Me,a1 as Ga,aq as Ba,B as Ha,aS as Wa,a3 as Ua,az as ka}from"./OutputColorHighlightOID.glsl-BnY819ab.js";import{t as ze,Q as Ve}from"./InterleavedLayout-Du3szcIS.js";import{s as S,T as bt,g as ce,I as He}from"./BufferView-CLWRARMH.js";import{r as Ya}from"./VertexBuffer-DL3Y72wO.js";import{g as Za}from"./plane-yhX0WOaZ.js";import{T as Le,d as Pe,_ as qa}from"./renderState-CKc66y4x.js";import{t as Xa}from"./VertexAttributeLocations-BfZbt_DV.js";import{t as i,n as p}from"./glsl-B5bJgrnA.js";import{s as ge}from"./ShaderBuilder-BLs3RjUy.js";function xe(a,e){switch(a.fragment.code.add(i`vec3 screenDerivativeNormal(vec3 positionView) {
...
return color;
}`)}const ke=U();function _t(a,e){const{hasModelTransformation:t,instancedDoublePrecision:r,instanced:o,output:s,hasVertexTangents:d}=e;t&&(a.vertex.uniforms.add(new ha("model",l=>l.modelTransformation??De)),a.vertex.uniforms.add(new I("normalLocalOriginFromModel",l=>(Xt(ke,l.modelTransformation??De),ke)))),o&&r&&(a.attributes.add("instanceModelOriginHi","vec3"),a.attributes.add("instanceModelOriginLo","vec3"),a.attributes.add("instanceModel","mat3"),a.attributes.add("instanceModelNormal","mat3"));const n=a.vertex;r&&(n.include(Ja,e),n.uniforms.add(new W("viewOriginHi",l=>ma(L(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)),new W("viewOriginLo",l=>pa(L(ie,l.camera.viewInverseTransposeMatrix[3],l.camera.viewInverseTransposeMatrix[7],l.camera.viewInverseTransposeMatrix[11]),ie)))),n.code.add(i`
...
}`),s&&d!==0&&(a.include(lt,e),t.uniforms.add(n===1?new y("normalTexture",u=>u.textureNormal):new se("normalTexture",u=>u.textureNormal)),l&&(t.uniforms.add(new ct("scale",u=>u.scale??Jt)),t.uniforms.add(new I("normalTextureTransformMatrix",u=>u.normalTextureTransformMatrix??k))),t.code.add(i`vec3 computeTextureNormal(mat3 tangentSpace, vec2 uv) {
...
float evaluateAmbientOcclusion() { return 0.0; }`)}function Co(a,e){const t=a.fragment,r=e.lightingSphericalHarmonicsOrder!==void 0?e.lightingSphericalHarmonicsOrder:2;r===0?(t.uniforms.add(new W("lightingAmbientSH0",({lighting:o})=>L(Ke,o.sh.r[0],o.sh.g[0],o.sh.b[0]))),t.code.add(i`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
...
float occlusion;`),o&&r.uniforms.add(l===1?new y("texMetallicRoughness",u=>u.textureMetallicRoughness):new se("texMetallicRoughness",u=>u.textureMetallicRoughness)),d&&r.uniforms.add(l===1?new y("texOcclusion",u=>u.textureOcclusion):new se("texOcclusion",u=>u.textureOcclusion)),r.uniforms.add(l===1?new ee("mrrFactors",u=>u.mrrFactors):new za("mrrFactors",u=>u.mrrFactors)),r.code.add(i`
  ...
  `)}let Vo=class extends me{constructor(e,t,r,o){super(e,"mat4",2,(s,d,n,l)=>s.setUniformMatrices4fv(e,t(d,n,l),o),r)}},Lo=class extends me{constructor(e,t,r,o){super(e,"mat4",1,(s,d,n)=>s.setUniformMatrices4fv(e,t(d,n),o),r)}};function Po(a){a.fragment.uniforms.add(new Lo("shadowMapMatrix",(e,t)=>t.shadowMap.getShadowMapMatrices(e.origin),4)),Nt(a)}function Eo(a){a.fragment.uniforms.add(new Vo("shadowMapMatrix",(e,t)=>t.shadowMap.getShadowMapMatrices(e.origin),4)),Nt(a)}function Nt(a){const{fragment:e}=a;e.uniforms.add(new _("cascadeDistances",t=>t.shadowMap.cascadeDistances),new $a("numCascades",t=>t.shadowMap.numCascades)),e.code.add(i`const vec3 invalidShadowmapUVZ = vec3(0.0, 0.0, -1.0);
...
}`)}function Do(a,e){e.hasColorTextureTransform?(a.varyings.add("colorUV","vec2"),a.vertex.uniforms.add(new I("colorTextureTransformMatrix",t=>t.colorTextureTransformMatrix??k)).code.add(i`void forwardColorUV(){
...
}`)):a.vertex.code.add(i`void forwardNormalUV(){}`)}function Bo(a,e){e.hasEmissionTextureTransform&&e.textureCoordinateType!==0?(a.varyings.add("emissiveUV","vec2"),a.vertex.uniforms.add(new I("emissiveTextureTransformMatrix",t=>t.emissiveTextureTransformMatrix??k)).code.add(i`void forwardEmissiveUV(){
emissiveUV = (emissiveTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):a.vertex.code.add(i`void forwardEmissiveUV(){}`)}function Ho(a,e){e.hasOcclusionTextureTransform&&e.textureCoordinateType!==0?(a.varyings.add("occlusionUV","vec2"),a.vertex.uniforms.add(new I("occlusionTextureTransformMatrix",t=>t.occlusionTextureTransformMatrix??k)).code.add(i`void forwardOcclusionUV(){
...
return mix(mrr, vec3(0.0, 1.0, 0.04), snow);
}`))}function Rt(a){const e=new ge,{attributes:t,vertex:r,fragment:o,varyings:s}=e,{output:d,normalType:n,offsetBackfaces:l,spherical:u,snowCover:f,pbrMode:v,textureAlphaPremultiplied:M,instancedDoublePrecision:C,hasVertexColors:g,hasVertexTangents:F,hasColorTexture:O,hasNormalTexture:Y,hasNormalTextureTransform:E,hasColorTextureTransform:R}=a;if(A(r,a),t.add("position","vec3"),s.add("vpos","vec3",{invariant:!0}),e.include(K,a),e.include(_t,a),e.include(mt,a),e.include(Do,a),!oe(d))return e.include(Ct,a),e;e.include(Go,a),e.include(Bo,a),e.include(Ho,a),e.include(Wo,a),le(r,a),e.include(xe,a),e.include(j);const V=n===0||n===1;return V&&l&&e.include(Mt),e.include(vo,a),e.include(wt,a),e.include(Tt,a),s.add("vPositionLocal","vec3"),e.include(D,a),e.include(St,a),e.include(pt,a),r.uniforms.add(new ft("externalColor",b=>b.externalColor,{supportsNaN:!0})),s.add("vcolorExt","vec4"),e.include(vt,a),r.include(fe),r.include(gt),e.include(C?It:Vt,a),r.main.add(i`
  ...
  `);const{hasColorTexture:M,hasColorTextureTransform:C}=a;return e.include(Ft,a),o.include(Ee,a),e.include(B,a),o.include(G,a),e.include(xt,a),le(o,a),ue(o),Ae(o),je(o),o.uniforms.add(r.uniforms.get("localOrigin"),r.uniforms.get("view"),new ee("ambient",g=>g.ambient),new ee("diffuse",g=>g.diffuse),new N("opacity",g=>g.opacity),new N("layerOpacity",g=>g.layerOpacity)),M&&o.uniforms.add(new y("tex",g=>g.texture)),e.include(Ot,a),o.include(Re,a),o.include(Pt),o.include(Et,a),te(o),o.main.add(i`
      discardBySlice(vpos);
      discardByTerrainDepth();
